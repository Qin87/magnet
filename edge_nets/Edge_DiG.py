...
from edge_data import generate_dataset_2class, generate_dataset_3class, in_out_degree, get_appr_directed_adj, get_second_directed_adj, link_prediction_evaluation
from preprocess import geometric_dataset, load_edge_index, load_syn
...
def parse_args():
    ...
    parser.add_argument('--task', type=int, default=3, help='2: 2-class classification 3: 3-class classification')

    parser.add_argument('--method_name', type=str, default='DiGib', help='method name')
...
if __name__ == "__main__":
    ...
    save_name = args.method_name + 'lr' + str(int(args.lr * 1000)) + 'num_filters' + str(int(args.num_filter)) + 'alpha' + str(int(100 * args.alpha)) + 'task' + str(int(args.task)) + 'link' + str(
