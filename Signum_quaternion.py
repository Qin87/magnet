...
class QuaNetConv_Qin(MessagePassing):
    ...
    def forward(
            ...
            X_imag_2: torch.FloatTensor,
            X_imag_3: torch.FloatTensor,
            norm_imag_1=None,norm_imag_2=None, norm_imag_3=None, norm_real=None, edge_index=None
    ) -> torch.FloatTensor:
        """
        Making a forward pass of the SigMaNet Convolution layer.
        ...
        return out_real, out_imag_1, out_imag_2, out_imag_3, norm_imag_1,norm_imag_2, norm_imag_3, norm_real, edge_index
...
class QuaNet_node_prediction_one_laplacian_Qin(nn.Module):
    r"""The QuaNet model for node classification
    Args:
        num_features (int): Size of each input sample.
        hidden (int, optional): Number of hidden channels.  Default: 2.
    ...
    def forward(self, real: torch.FloatTensor, imag_1: torch.FloatTensor, imag_2: torch.FloatTensor, \
                imag_3: torch.FloatTensor, norm_imag_1,norm_imag_2, norm_imag_3, norm_real, edges) -> torch.FloatTensor:
        """
        Arg types:
            * real, imag (PyTorch Float Tensor) - Node features.
            * edge_index (PyTorch Long Tensor) - Edge indices.
        ...
        """
        for cheb in self.Chebs:
            real, imag_1, imag_2, imag_3,norm_imag_1,norm_imag_2, norm_imag_3, norm_real, edges = cheb(real, imag_1, imag_2, imag_3, norm_imag_1,norm_imag_2, norm_imag_3, norm_real, edges)
            if self.activation:
                real, imag_1, imag_2, imag_3 = self.complex_relu(real, imag_1, imag_2, imag_3)
