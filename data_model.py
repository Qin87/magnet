...
from nets.DiG_NoConv import create_DiGSimple, create_DiG_IB_SymCat, create_DiG_MixIB_SymCat, create_DiG_IB_batch, create_DiG_IB_Sym_batch, create_DiG_MixIB_SymCat_Sym, create_DiG_MixIB_SymCat_batch
                    ...
                    if args.net[9:].startswith('Mix'):
                        if args.net[12:].startswith('Sym'):
                            ...
                            if not args.largeData:
                                ...
                                model = create_DiG_MixIB_SymCat_batch(num_features, args.feat_dim, n_cls, args.dropout, args.layer).to(device)
                    else:
