...
net_values="QiGQymCatib "
q_value=0.5
Aug_value=0
layer_values=" 2  "    #

Direct_dataset=('WebKB/texas' 'cora_ml/' 'citeseer_npz/'  'WebKB/Cornell' 'WebKB/wisconsin')  # Update your Direct_dataset value
    ...
    for Aug in $Aug_value; do
        for layer in $layer_values; do
          ...
          for net in $net_values; do
            nohup python3 All2MainStop.py --AugDirect=$Aug --net=$net      \
