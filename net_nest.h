...
for Didataset in "${Direct_dataset[@]}"; do
    for layer in $layer_values; do
        ...
        for net in $net_values; do
            ...
            python3 main.py   --patience=150 --feat_dim=128  --dropout=0.0  --lr=0.005 --l2=0.0 --net="$net"  --layer="$layer"   --epoch=15000  --NotImproved=500 --Dataset="$Didataset" > "$log_output" 2>&1
            wait $pid
          done
        done
        done
