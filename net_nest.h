...
net_values="addQym Qym addQympara "
q_value=0
...
Direct_dataset=( 'film/')  # 'cora_ml/'  'citeseer_npz/'  'WebKB/Cornell' 'WebKB/wisconsin'  'WebKB/texas' 'WebKB/texas' 'WebKB/wisconsin'  telegram/telegram
