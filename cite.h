...
#   'citeseer_npz/' 'cora_ml/'  'telegram/telegram' 'dgl/pubmed'  'WikiCS/'  'dgl/cora'
Direct_dataset=(  'citeseer_npz/'  'cora_ml/'  'telegram/telegram' 'dgl/pubmed'  'WikiCS/' )  # 'cora_ml/'  'citeseer_npz/'  'WebKB/Cornell' 'WebKB/wisconsin'  'WebKB/texas' 'WebKB/texas' 'WebKB/wisconsin'  telegram/telegram
...
python3 main.py   --jk='max'   --alphaDir="$alphadir"  --betaDir="$betadir"  --gamaDir=3  --use_best_hyperparams  \
