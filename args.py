...
def parse_args():
    ...
    parser.add_argument('--net', type=str, default='gprgnn', help='addSym, UGCL,DiGSymib, DiGSymCatib, DiGSymCatMixib, DiGSymCatMixSymib, MagQin, DiGib,QuaNet, '
    ...
    parser.add_argument('--Direct_dataset', type=str, default='WebKB/wisconsin', help='dgl/cora, dgl/citeseer, dgl/pubmed..., '
