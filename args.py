...
def parse_args():
    ...
    parser.add_argument('--net', type=str, default='SymDiGCN', help='addSym, UGCL,DiGSymib, DiGSymCatib, DiGSymCatMixib, MagQin')
    ...
    #  from Magnet
    parser.add_argument('--q', type=float, default=2, help='q value for the phase matrix')
