...
def parse_args():
    ...
    parser.add_argument('--net', type=str, default='iiGi3', help='addSym, UGCL,DiGSymib, DiGSymCatib, DiGSymCatMixib, DiGSymCatMixSymib, MagQin, DiGib,QuaNet, addQymN1(*Ym without 1st)'
