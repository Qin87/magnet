...
def parse_args():
    ...
    parser.add_argument("--self_loop", action="store_false", help="Whether to add self-loops to the graph")
    parser.add_argument("--has_1_order", action="store_false", help="Whether Ai* has 1-order edges")
    ...
    parser.add_argument('--net', type=str, default='QiG', help='addSym, UGCL,DiGSymib, DiGSymCatib, DiGSymCatMixib, DiGSymCatMixSymib, MagQin, DiGib,QuaNet, addQymN1(*Ym without 1st)'
