...
def parse_args():
    ...
    parser.add_argument('--Direct_dataset', type=str, default='dgl/yelp', help='citeseer_npz/ , cora_ml/, dgl/pubmed, '
                                                                                'dgl/computer, dgl/coauthor-cs, dgl/coauthor-ph, dgl/reddit, ...,   WikiCS/ '
