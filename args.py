...
def parse_args():
    ...
    parser.add_argument('--Direct_dataset', type=str, default='dgl/citeseer', help='dgl/cora, dgl/citeseer, ..., citeseer_npz/ , cora_ml/,  WikiCS/, '
    ...
    parser.add_argument('--net', type=str, default='Cheb', help='GNN bachbone, chosen from GCN, GAT, SAGE, APPNP, Cheb, DIG, SymDiGCN, GIN')
