...
def parse_args():
    ...
    parser.add_argument('--net', type=str, default='addSym', help='addSym, UGCL,DiGSymib, DiGSymCatib, DiGSymCatMixib, MagQin')
    ...
    parser.add_argument('--Direct_dataset', type=str, default=''
