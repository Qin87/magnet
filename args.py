...
def parse_args():
    ...
    parser.add_argument('--AugDirect', type=int, default=22, help='0 for noAug, 1 for one direction, 2 for bidirection aug edges, '
    ...
    parser.add_argument('--Direct_dataset', type=str, default='dgl/cora', help='dgl/cora ')
    # parser.add_argument('--data_path', type=str, default='datasets/', help='data path')
    parser.add_argument('--imb_ratio', type=float, default=100, help='imbalance ratio')
    parser.add_argument('--net', type=str, choices=['GCN', 'GAT', 'SAGE'], default='GAT', help='GNN bachbone')
