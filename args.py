...
def parse_args():
    ...
    parser.add_argument('--AugDirect', type=int, default=2311,
 help='0 for noAug, 1 for one direction, 2 for bidirection aug edges, '
    ...
    parser.add_argument('--Direct_dataset', type=str, default='citeseer_npz/', help='dgl/cora, citeseer_npz/ , cora_ml/,  ')
