...
def parse_args():
    ...
    parser.add_argument('--AugDirect', type=int, default=23,  help='0 for noAug, 1 for one direction, 2 for bidirection aug edges, '
    ...
    parser.add_argument('--net', type=str, default='DiG', help='device')
