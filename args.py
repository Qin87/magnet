...
def parse_args():
    ...
    parser.add_argument('--AugDirect', type=int, default=21, help='0 for noAug, 1 for one direction, 2 for bidirection aug edges, 100 for link prediction'
    ...
    parser.add_argument('--net', type=str, default='DiGu4', help='addSym, UGCL,DiGSymib, DiGSymCatib, DiGSymCatMixib, DiGSymCatMixSymib, MagQin, DiGib,QuaNet, '
