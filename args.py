...
def parse_args():
    ...
    parser.add_argument('--net', type=str, default='addSym', help='addSym, UGCL,DiGSymib, DiGSymCatib, DiGSymCatMixib, DiGSymCatMixSymib, MagQin, QuaNet')
    ...
    parser.add_argument('--Direct_dataset', type=str, default='cora_ml/'
