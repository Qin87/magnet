...
def parse_args():
    ...
    parser.add_argument('--net', type=str, default='addQym', help='addSym, UGCL,DiGSymib, DiGSymCatib, DiGSymCatMixib, DiGSymCatMixSymib, MagQin, DiGib,QuaNet, '
    ...
    parser.add_argument('--Direct_dataset', type=str, default='dgl/amazon', help='citeseer_npz/ , cora_ml/, dgl/pubmed, '
