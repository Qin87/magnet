...
Direct_dataset=( 'WikipediaNetwork/squirrel'   )  # 'cora_ml/'  'citeseer_npz/'  telegram/telegram
...
python3 main.py   --jk='cat'  --BN_model=1  --First_self_loop='add' --lr=0.01 --dropout=0.5  \
